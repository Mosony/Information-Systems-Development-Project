...
<form action="UgyfelekControllerServlet" method="GET">
	...
	<div class="kozep">
			<input class="form-control form-control-lg" type="text" name="igazolvanySzam" placeholder="Igazolvány száma" />
			<input class="form-control form-control-lg" type="text" name="vezetekNev" placeholder="Vezetéknév" />
			<input class="form-control form-control-lg" type="text" name="keresztNev" placeholder="Keresztnév" />
			<input class="form-control form-control-lg" type="text" name="telefonSzam" placeholder="Telefonszám" />
