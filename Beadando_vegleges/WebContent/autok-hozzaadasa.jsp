...
<div class="jumbotron jumbotron-fluid bg-dark text-white">
	<div class="container-fluid wrapper">
		<h1 class="display-4">Autók hozzáadása!</h1>		
	</div>
</div>
...
<form action="AutokControllerServlet" method="GET">
	...
	<div class="kozep">
			<input class="form-control form-control-lg" type="text" name="marka" placeholder="Márka"  pattern="[A-Z ÁŰÚÉÓÜÖÍŐ][a-z áűúéóüöíő]+$" />
			<input class="form-control form-control-lg" type="text" name="rendszam" placeholder="Rendszám"  pattern="[A-Z]{3}-[0-9]{3}"/>
			<input class="form-control form-control-lg" type="text" name="tipus" placeholder="Típus"  />
			<select class="form-control form-control-lg" name="statusz">
  				<option>Szabad</option>
  				<option>Foglalt</option>
			</select>
			<input class="form-control form-control-lg" type="text" name="kolcsonzesi_dij" placeholder="Kölcsönzési díj (Ft/Óra)" pattern="[0-9]+" />
